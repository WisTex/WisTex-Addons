...
/**
 * * Test Plugin Module
 * This is a module that is part of the "extra_theme_vars" addon.
 * This module's URL is example.com/extra_theme_vars
*/
...
// Extra_theme_vars class "controller" logic for the plugin's "extra_theme_vars" route
class Extra_theme_vars extends Controller {
	...
	public function get(): string {
		...
		// If this is an Add request, load "config" (database table) settings in the "extra_theme_vars" category into an array
		if (!$isEditAction) {
			$variables = [];
